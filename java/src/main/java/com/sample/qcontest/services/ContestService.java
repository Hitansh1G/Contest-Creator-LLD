...
public class ContestService{
    ...
    public Contestant createContestant(Long contestId, String userName) {
        // Contest contest = new Contest(contest.getTitle(), contest.getLevel(), contest.getCreator(), contest.getQuestions());
        
        // ContestRepository con = new ContestRepository();
        // ((IContestantRepository) con).find(contestId,userName);
        // UserRepository name = new UserRepository();
        // name.findByName(userName);
        //it has to be user and contest type variables as parameter
        // User user = new User(userName,contestId);
        ...
        // }
        // User us = new User(userName,us.getId());

        // Contest temp = new Contest(us, contest);
        // Contestant con = ContestRepository.save(temp);
        // ContestantRepository repo = new ContestantRepository();
